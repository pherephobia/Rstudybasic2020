...
2020-09-12
  ...
  - [Introduction to **R**](#intro)
      - [기본 동작에 관한 소개](#기본-동작에-관한-소개)
      - [**R**의 연산자(operations)](#r의-연산자operations)
      - [**R**의 기본적인 자료 유형](#r의-기본적인-자료-유형)
      - [벡터 (Vectors)](#벡터-vectors)
      - [매트릭스 (Matrices)](#매트릭스-matrices)
      - [데이터프레임 (Data frame)](#데이터프레임-data-frame)
      - [티블 (Tibbles)](#티블-tibbles)
      - [패키지 (Packages)](#패키지-packages)
      - [디렉토리 생성 코드](#디렉토리-생성-코드)
      - [용례 (A working example)](#용례-a-working-example)
      - [기타 참고자료](#기타-참고자료)
  - [Introduction to A Little Bit Advanced
    **R**](#introduction-to-a-little-bit-advanced-r)
      - [데이터의 구조](#데이터의-구조)
      - [리스트](#리스트)
      - [데이터프레임](#데이터프레임)
      - [티블](#티블)
      - [루프와 함수형 프로그래밍(Loops &
        functionals)](#루프와-함수형-프로그래밍loops-functionals)
      - [파이프(%\>%)](#파이프)
      - [Tidyverse를 위한 기타 참고자료](#tidyverse를-위한-기타-참고자료)
...
**R**을 배우면 배울수록, 여러가지 노하우가 체화되고 보다 효율적인 코딩을 시도하게 되는데, 일단 간단한 팁들은
...
이번에는 매트릭스를 살펴보겠습니다. 매트릭스는 일정한 수의 열과 행으로 이루어진 두 차원(two dimension)의 집합이라고
...
**R**의 패키지는 함수와 객체의 모음(collection of functions and objects)이라고 할 수 있습니다.
...
아래는 실제로 코딩을 이용해서 자료를 요약하거나 가시화하는 사례들입니다. 앞으로는 다음과 같은 내용들을 차근차근 다루어볼
것입니다.
...
<img src="w1_intro2R_files/figure-gfm/unnamed-chunk-24-1.png" style="display: block; margin: auto;" />
...
<img src="w1_intro2R_files/figure-gfm/unnamed-chunk-24-2.png" style="display: block; margin: auto;" />
...
<img src="w1_intro2R_files/figure-gfm/unnamed-chunk-24-3.png" style="display: block; margin: auto;" />
...
가장 기본적으로(그리고 중요하게) 알아두어야 할 데이터 구조는 바로 원자 벡터(atomic vectors), 리스트(lists),
